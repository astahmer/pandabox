...
const link = cx('group', hstack({ _hover: { color: { _dark: 'blue.300', _light: 'blue.500' } } }))
const linkTitle = css({
        ...
        <Stack>
          ...
          <Stack gap="1" mt="4">
            <Link className={link} to="/styled2panda">
              - <LuLink /> <span className={linkTitle}>`styled2panda`</span>: Easily migrate code from
              `styled-components` to Panda CSS
            </Link>
            ...
            <a
              ...
              target="_blank"
            >
              - <LuExternalLink /> <span className={linkTitle}>`defineRecipe`</span>: Extend, pick, omit and merge
              config Recipes/Slots Recipes to easily compose them together.
            </a>
          </Stack>
        </Stack>
      </Center>
