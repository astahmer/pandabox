...
import { transformPropTypes, type StrictTokensScopeOptions } from '../src'

const propTypes = (userConfig: Config, options: StrictTokensScopeOptions) => {
  const ctx = createContext(userConfig)
  const artifacts = ctx.getArtifacts(['types-styles'])
  const updated = transformPropTypes({ artifacts, changed: undefined }, options)
  return updated.find((x) => x.id === 'types-styles')?.files.find((x) => x.file.includes('prop-type'))!.code
}

describe('strict-tokens-scope', () => {
  test('empty', () => {
    expect(propTypes({}, { categories: [], props: [] })).toMatchInlineSnapshot(`
      "/* eslint-disable */
  ...
  test('colors', () => {
    expect(propTypes({}, { categories: ['colors'], props: [] })).toMatchInlineSnapshot(`
      "/* eslint-disable */
      import type { ConditionalValue } from './conditions';
      import type { CssProperties } from './system-types';
      import type { Tokens } from '../tokens/index';
      ...
      type StrictTokenProps = "outlineColor" | "divideColor" | "color" | "textDecorationColor" | "textEmphasisColor" | "textShadowColor" | "background" | "backgroundColor" | "gradientFrom" | "gradientTo" | "gradientVia" | "borderColor" | "borderInlineColor" | "borderBlockColor" | "borderLeftColor" | "borderInlineStartColor" | "borderRightColor" | "borderInlineEndColor" | "borderTopColor" | "borderBottomColor" | "borderBlockEndColor" | "borderBlockStartColor" | "boxShadowColor" | "accentColor" | "caretColor" | "fill" | "stroke" | "ringColor" | "divideColor" | "color" | "textDecorationColor" | "textEmphasisColor" | "textShadowColor" | "bg" | "bgColor" | "gradientFrom" | "gradientTo" | "gradientVia" | "borderColor" | "borderXColor" | "borderYColor" | "borderLeftColor" | "borderStartColor" | "borderRightColor" | "borderEndColor" | "borderTopColor" | "borderBottomColor" | "borderBlockEndColor" | "borderBlockStartColor" | "shadowColor" | "accentColor" | "caretColor" | "fill" | "stroke"
  ...
  test('colors + fontSizes', () => {
    expect(propTypes({}, { categories: ['colors', 'fontSizes'], props: [] })).toMatchInlineSnapshot(`
      "/* eslint-disable */
      import type { ConditionalValue } from './conditions';
      import type { CssProperties } from './system-types';
      import type { Tokens } from '../tokens/index';
      ...
      type StrictTokenProps = "outlineColor" | "divideColor" | "color" | "fontSize" | "textDecorationColor" | "textEmphasisColor" | "textShadowColor" | "background" | "backgroundColor" | "gradientFrom" | "gradientTo" | "gradientVia" | "borderColor" | "borderInlineColor" | "borderBlockColor" | "borderLeftColor" | "borderInlineStartColor" | "borderRightColor" | "borderInlineEndColor" | "borderTopColor" | "borderBottomColor" | "borderBlockEndColor" | "borderBlockStartColor" | "boxShadowColor" | "accentColor" | "caretColor" | "fill" | "stroke" | "ringColor" | "divideColor" | "color" | "fontSize" | "textDecorationColor" | "textEmphasisColor" | "textShadowColor" | "bg" | "bgColor" | "gradientFrom" | "gradientTo" | "gradientVia" | "borderColor" | "borderXColor" | "borderYColor" | "borderLeftColor" | "borderStartColor" | "borderRightColor" | "borderEndColor" | "borderTopColor" | "borderBottomColor" | "borderBlockEndColor" | "borderBlockStartColor" | "shadowColor" | "accentColor" | "caretColor" | "fill" | "stroke"
  ...
  test('color prop only', () => {
    expect(propTypes({}, { props: ['color'] })).toMatchInlineSnapshot(`
      "/* eslint-disable */
      import type { ConditionalValue } from './conditions';
      import type { CssProperties } from './system-types';
      import type { Tokens } from '../tokens/index';
  ...
  test('spacing', () => {
    expect(propTypes({}, { categories: ['spacing'] })).toMatchInlineSnapshot(`
      "/* eslint-disable */
      import type { ConditionalValue } from './conditions';
      import type { CssProperties } from './system-types';
      import type { Tokens } from '../tokens/index';
